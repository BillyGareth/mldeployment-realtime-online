...
conml = mysql.connector.connect(user='root', password='Success100%',
                              host='localhost',
                              database='mldeploy', auth_plugin='mysql_native_password')
dataset = pd.read_sql_query("SELECT * from sales", conml)
